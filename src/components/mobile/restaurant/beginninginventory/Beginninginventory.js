...
import { searchBranchName } from '../../../../api/branchApi';
...
export default function BeginningInventory() {
    ...
    const loadStockcardData = async (pageNumber = 1) => {
        try {
            ...
            if (selectedBranchCode) {
                branchParams.branch_code = selectedBranchCode;
            }
    ...
    useEffect(() => {
        loadStockcardData(page);
    }, [filterDate, tableSearchTerm, selectedBranchCode, page]);

    // เพิ่มฟังก์ชันจัดการการเปลี่ยนแปลงของ dropdown
