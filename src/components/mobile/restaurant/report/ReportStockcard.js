            ...
            <Box sx={{
                ...
                <Box sx={{ width: '100%' }}>
                    ...
                    <Box sx={{
                        ...
                        mt: 3,
                        overflow: 'auto',
                        // เพิ่ม styles ต่อไปนี้เพื่อให้ตารางแสดงผลได้ดีขึ้น
                        '& table': {
                            borderCollapse: 'separate',
                            borderSpacing: 0,
                            width: '100%',
                        },
                        // เพิ่ม style สำหรับ sticky columns
                        ...
                        // ให้ header columns อยู่ด้านหน้าเสมอ
                        ...
                        <table style={{ width: '100%', marginTop: '24px' }}>
                            <thead>
                                <tr>
                                    <th style={{ padding: '12px 16px', textAlign: 'center', color: '#754C27', minWidth: '60px', backgroundColor: 'white' }}>No.</th>
                                    <th style={{ padding: '12px 16px', textAlign: 'left', color: '#754C27', minWidth: '120px', backgroundColor: 'white' }}>Ref No</th>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    stockcardData.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={item.refno}>
                                                <td style={{ padding: '8px 16px', textAlign: 'center', backgroundColor: 'white' }}>{index + 1}</td>
                                                <td style={{ padding: '8px 16px', textAlign: 'left', backgroundColor: 'white' }}>{item.refno}</td>
                            ...
                            {stockcardData.length > 0 && (
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colSpan="2" style={{ textAlign: 'right', padding: '12px 16px', fontWeight: 'bold', color: '#754C27', backgroundColor: 'white' }}>
                                            Total:
                                        </td>
