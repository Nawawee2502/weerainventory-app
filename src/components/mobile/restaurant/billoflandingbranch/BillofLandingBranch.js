...
import { TextField, Select, MenuItem, Card, CardContent, Typography, Paper, Grid, InputAdornment, Fab, Button,From,}from "@mui/material";
...
import { Checkbox, Switch, Divider, IconButton } from '@mui/material';
...
<div style={{ border: '1px solid #ddd', borderRadius: '10px', padding: '20px', margin: '10px 0', fontFamily: 'Arial, sans-serif', boxShadow: '0 2px 5px rgba(0, 0, 0, 0.1)' }}>
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
    ...
    <button style={{ background: 'none', border: 'none', color: '#f44336', cursor: 'pointer',paddingLeft:'80px' }}><DeleteIcon style={{color:'#BEBEBE'}} /></button> {/*🗑️*/}
    <button style={{ background: 'none', border: 'none', fontSize: '20px', color: '#f44336', cursor: 'pointer',paddingRight:'10px' }}><Checkbox /></button>
  </div>
  <div>
    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}><span>Unit</span><span>Bag of</span></div>
  ...
  return (
    ...
    >
      ...
      style={{
        ...
        alignItems: "center", // จัดตำแหน่งตรงกลาง
        gap: "10px", // เพิ่มระยะห่างระหว่าง Select
