...
const InvoiceToBranch = () => {
  ...
  const goodsReceiptData = [
    ...
    { refNo: '0002', supplier: "Supplier B", date: "2025-01-16", amount: 200, branch: "Branch B",kitchen:"Room4" },
    { refNo: '0003', supplier: "Supplier C", date: "2025-01-17", amount: 150, branch: "Branch C",kitchen:"Room5" },
  ];
        ...
        <Typography sx={{ fontSize: '16px', fontWeight: '600', mt: '18px' }}>
                  ...
                  <Typography sx={{ fontSize: '16px', fontWeight: '600', mt: '18px' }}>
                        ...
                        <Box sx={{ position: 'relative', width: '100%' }}>
                          ...
                          >
                            <MenuItem value="">
                              <em> Branch</em> {/* Placeholder option */}
                            </MenuItem>
                            {/* {branches.map((branch, index) => (
                              <MenuItem key={index} value={branch}>
                                {branch}
                ...
                <Table sx={{}} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align="center">Kitcken</StyledTableCell>
...
export default InvoiceToBranch;
