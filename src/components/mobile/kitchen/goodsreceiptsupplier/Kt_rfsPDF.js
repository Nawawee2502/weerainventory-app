...
export const ReceiptFromSupplierPDF = ({ refNo, date, kitchen, kitchenName, supplier, supplierName, productArray, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
