...
const KitchenStockBalancePDF = ({ data, excludePrice = false, startDate, endDate, kitchen = '' }) => {
    // Calculate totals
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                ...
                <View style={[styles.tableRow, styles.tableHeader]}>
                    ...
                    <Text style={styles.cellKitchen}>Kitchen</Text>
                ...
                {data.map((item, index) => {
                    ...
                    return (
                        <View key={index} style={styles.tableRow}>
                            ...
                            <Text style={styles.cellKitchen}>{item.tbl_kitchen?.kitchen_name}</Text>
