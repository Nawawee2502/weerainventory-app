...
const PrintPreviewKitchenStockBalance = ({ data, excludePrice = false, startDate, endDate, kitchen = '' }) => {
    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                ...
                <p>Kitchen Stock Balance Report</p>
            ...
            <table style={styles.table}>
                    ...
                    {data.map((item, index) => {
                        ...
                        return (
                            <tr key={index}>
                                ...
                                <td style={styles.td}>{item.tbl_kitchen?.kitchen_name}</td>
                ...
                <tfoot>
                    <tr>
                        <td colSpan="4" style={{ ...styles.td, ...styles.total }}>Total:</td>
