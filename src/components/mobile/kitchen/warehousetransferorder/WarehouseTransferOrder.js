...
const WarehouseTransferOrder = () => {
  ...
  const goodsReceiptData = [
    { refNo: '0001', supplier: "Supplier A", date: "2025-01-15", amount: 100, branch: "Branch A",kitchen:"Room5" },
  ...
  return (
    ...
    >
      <ArrowBackIcon style={{ fontSize: "24px" }} />
        ...
        <TextField
          placeholder="Transfer Order Search"
          size="small"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          sx={{
...
export default WarehouseTransferOrder;
