...
export const GoodsRequisitionPDF = ({ refNo, date, kitchen, kitchenName, productArray, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
        <Page style={styles.page} size="A4">
            ...
            {/* Document Title */}
            <Text style={styles.documentTitle}>GOODS REQUISITION FORM</Text>
            ...
            <View style={styles.notesSection}>
                <Text style={styles.notesTitle}>Purpose:</Text>
                <Text style={styles.notesText}>Items requisitioned for kitchen operations.</Text>
                <Text style={styles.notesTitle}>Notes:</Text>
                <Text style={styles.notesText}>1. All items are subject to availability.</Text>
                <Text style={styles.notesText}>2. Please ensure proper approval before submission.</Text>
            </View>
            ...
            <View style={styles.footer}>
                <Text>This is an official requisition document from {kitchenName}. Ref# {refNo}</Text>
            </View>
        </Page>
    </Document>
);
