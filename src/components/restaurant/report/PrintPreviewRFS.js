    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                ...
                <div style={styles.titleText}>Receipt From Supplier (Branch)</div>
            ...
            <table style={styles.table}>
                <thead>
                    <tr>
                        ...
                        <th style={{ ...styles.th, ...styles.leftText, width: '120px' }}>Supplier</th>
                ...
                <tbody>
                    {groupedData.map((row, index) => (
                        <tr key={index}>
                            ...
                            <td style={{ ...styles.td, ...styles.leftText }}>{row.branch}</td>
                            <td style={{ ...styles.td, ...styles.leftText }}>{row.supplier}</td>
                ...
                <tfoot>
                    <tr>
                        <td colSpan={excludePrice ? 11 : 13} style={{ ...styles.td }}></td>
                        {!excludePrice && (
