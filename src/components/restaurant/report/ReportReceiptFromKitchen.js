...
import { Br_rfkAlljoindt } from '../../../api/restaurant/br_rfkApi';
import { exportToExcelRfk } from './ExportExcelRFK';
import { branchAll } from '../../../api/branchApi';
import { kitchenAll } from '../../../api/kitchenApi';
import { exportToPdfRfk } from './ExportPdfRFK';
import PrintLayout from './PrintPreviewRFK';
...
export default function ReportReceiptFromKitchen() {
    ...
    const fetchData = async (params) => {
        try {
            const response = await dispatch(Br_rfkAlljoindt(params)).unwrap();
            console.log("API Response:", response);

            if (response.data) {
                const flattenedData = response.data.flatMap(order =>
                    order.br_rfkdts.map(detail => ({
                        date: order.rdate,
                        refno: order.refno,
    ...
    const handleExportExcel = () => {
        ...
        exportToExcelRfk(rfkData, excludePrice, startDate, endDate);
    };
    ...
    const handleExportPdf = () => {
        ...
        exportToPdfRfk(rfkData, excludePrice, startDate, endDate);
    };
