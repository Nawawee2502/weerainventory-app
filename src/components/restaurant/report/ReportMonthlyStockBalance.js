                    ...
                    <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', mb: '12px' }}>
                        <table style={{ width: '100%', marginTop: '24px' }}>
                            ...
                            <tbody>
                                {loading ? (
                                    <tr>
                                        <td colSpan={excludePrice ? 8 : 9} style={{ textAlign: 'center', padding: '20px' }}>Loading...</td>
                                    </tr>
                                ) : error ? (
                                    <tr>
                                        <td colSpan={excludePrice ? 8 : 9} style={{ textAlign: 'center', padding: '20px', color: 'red' }}>{error}</td>
                                    </tr>
                                ) : stockBalanceData.length === 0 ? (
                                    <tr>
                                        <td colSpan={excludePrice ? 8 : 9} style={{ textAlign: 'center', padding: '20px' }}>No data found</td>
                                    </tr>
                                ) : (
