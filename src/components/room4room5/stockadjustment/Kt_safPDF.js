...
export const StockAdjustmentPDF = ({ refNo, date, kitchen, kitchenName, productArray, total, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
        <Page style={styles.page} size="A4">
            ...
            {/* Document Title */}
            <Text style={styles.documentTitle}>KITCHEN STOCK ADJUSTMENT FORM</Text>
            ...
            <View style={styles.footer}>
                <Text>This is an official stock adjustment document from {kitchenName}. Adjustment# {refNo}</Text>
            </View>
        </Page>
    </Document>
);
