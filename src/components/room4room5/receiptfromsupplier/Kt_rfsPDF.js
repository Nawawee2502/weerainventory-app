...
// Main PDF Component for Receipt From Supplier
export const ReceiptFromSupplierPDF = ({ refNo, date, kitchen, kitchenName, supplier, supplierName, productArray, total, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
        <Page style={styles.page} size="A4">
            ...
            {/* Document Title */}
            <Text style={styles.documentTitle}>RECEIPT FROM SUPPLIER</Text>

            {/* Kitchen and Supplier Info */}
            ...
            <View style={styles.notesSection}>
                ...
                <Text style={styles.notesText}>1. This document confirms receipt of items from supplier.</Text>
            ...
            <View style={styles.signatureSection}>
                ...
                <View style={styles.signatureBox}>
                    <Text style={styles.signatureLine}></Text>
                    <Text style={styles.signatureText}>Supplier</Text>
                </View>
            </View>
...
export const generatePDF = async (refno, data) => {
    ...
    console.log("Data for Receipt From Supplier PDF:", data);
    ...
    // Create product array from kt_rfsdts
    const productArray = Array.isArray(data.kt_rfsdts)
        ? data.kt_rfsdts.map(item => ({
            ...item,
