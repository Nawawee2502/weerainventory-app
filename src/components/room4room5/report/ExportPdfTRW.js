...
const TransferToWarehousePDF = ({ data, excludePrice = false, startDate, endDate }) => {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Transfer to Warehouse</Text>
                ...
                <View style={styles.table}>
                    ...
                    {groupedData.map((row, index) => (
                        <View key={index} style={styles.tableRow}>
                            ...
                            <View style={[styles.tableCol, { width: '6%' }]}>
                                <Text style={[styles.tableCell, styles.rightText]}>{row.quantity}</Text>
                            </View>
                            {!excludePrice && (
                                <View style={[styles.tableCol, { width: '8%' }]}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={[styles.tableCol, { width: excludePrice ? '84%' : '68%' }]}>
                            <Text style={[styles.tableCell, styles.rightText]}>Total:</Text>
                        </View>
                        {!excludePrice && (
                            <View style={[styles.tableCol, { width: '8%' }]}>
                                <Text style={[styles.tableCell, styles.rightText, { fontWeight: 'bold' }]}>
...
export const exportToPdfTrw = async (data, excludePrice = false, startDate, endDate) => {
    try {
        ...
        link.href = url;
        link.download = `transfer_to_warehouse_${new Date().toISOString().split('T')[0]}.pdf`;
