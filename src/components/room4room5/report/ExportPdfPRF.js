...
const ProductionReceiptPDF = ({ data, excludePrice = false, startDate, endDate }) => {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Production Receipt</Text>
...
export const exportToPdfPrf = async (data, excludePrice = false, startDate, endDate) => {
    try {
        ...
        link.href = url;
        link.download = `production_receipt_${new Date().toISOString().split('T')[0]}.pdf`;
