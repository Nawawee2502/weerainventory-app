...
const DispatchToRestaurantPDF = ({ data, excludePrice = false, startDate, endDate, selectedKitchen }) => {
    ...
    const renderTableHeader = () => (
        <View style={styles.tableRow}>
            ...
            <View style={[styles.tableColHeader, { width: '12%' }]}>
                <Text style={styles.tableCellHeader}>Restaurant</Text>
            </View>
            <View style={[styles.tableColHeader, { width: '8%' }]}>
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Dispatch to Restaurant</Text>
                ...
                <View style={styles.table}>
                    ...
                    {groupedData.map((row, index) => (
                        <View key={index} style={styles.tableRow}>
                            ...
                            <View style={[styles.tableCol, { width: '12%' }]}>
                                <Text style={styles.tableCell}>{row.restaurant}</Text>
                            </View>
                            <View style={[styles.tableCol, { width: '8%' }]}>
...
export const exportToPdfDpb = async (data, excludePrice = false, startDate, endDate, selectedKitchen) => {
    try {
        ...
        link.href = url;
        link.download = `dispatch_to_restaurant_${new Date().toISOString().split('T')[0]}.pdf`;
