...
const ReceiptFromWarehousePDF = ({ data, excludePrice = false, startDate, endDate }) => {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Receipt From Warehouse</Text>
...
export const exportToPdfRfw = async (data, excludePrice = false, startDate, endDate) => {
    try {
        ...
        link.href = url;
        link.download = `receipt_from_warehouse_${new Date().toISOString().split('T')[0]}.pdf`;
