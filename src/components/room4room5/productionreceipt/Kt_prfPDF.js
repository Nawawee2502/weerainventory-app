...
// Main PDF Component for Production Receipt Form
export const ProductionReceiptPDF = ({ refNo, date, kitchen, kitchenName, productArray, total, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
        <Page style={styles.page} size="A4">
            ...
            {/* Document Title */}
            <Text style={styles.documentTitle}>PRODUCTION RECEIPT FORM</Text>
            ...
            <View style={styles.infoSection}>
                ...
                <View style={styles.infoBoxRight}>
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.infoValue}>{kitchenAddr1}</Text>
                    </View>
                    <View style={styles.infoRow}>
                        <Text style={styles.infoLabel}>Phone:</Text>
                        <Text style={styles.infoValue}>{kitchenTel1}</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.totalSection}>
                <View style={styles.totalTable}>
                    <View style={[styles.totalRow, { borderBottomWidth: 0 }]}>
                        <Text style={styles.grandTotalLabel}>TOTAL PRODUCTION:</Text>
            ...
            <View style={styles.notesSection}>
                ...
                <Text style={styles.notesText}>1. This document confirms the receipt of produced items into kitchen inventory.</Text>
                <Text style={styles.notesText}>2. All items have been inspected for quality and quantity.</Text>
                <Text style={styles.notesText}>3. Inventory has been updated accordingly.</Text>
            </View>
            ...
            <View style={styles.footer}>
                <Text>This is an official production receipt document from {kitchenName}. Ref# {refNo}</Text>
            </View>
        </Page>
    </Document>
);
...
export const generatePDF = async (refno, data) => {
    ...
    console.log("Data for Production Receipt PDF:", data);
    ...
    // Create product array from kt_prfdts
    const productArray = Array.isArray(data.kt_prfdts)
        ? data.kt_prfdts.map(item => ({
            ...item,
