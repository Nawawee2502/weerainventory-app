...
// Main PDF Component for Purchase Order to Warehouse
export const PurchaseOrderWarehousePDF = ({ refNo, date, kitchen, kitchenName, productArray, total, username, data, kitchenAddr1, kitchenAddr2, kitchenTel1 }) => (
    <Document>
        <Page style={styles.page} size="A4">
            {/* Header with kitchen info and PO number */}
            ...
            {/* Document Title */}
            <Text style={styles.documentTitle}>PURCHASE ORDER TO WAREHOUSE</Text>
            ...
            <View style={styles.footer}>
                <Text>This is an official purchase order from {kitchenName}. PO# {refNo}</Text>
            </View>
        </Page>
    </Document>
);
...
export const generatePDF = async (refno, data) => {
    ...
    console.log("Data for Purchase Order Warehouse PDF:", data);
    ...
    // Create product array from kt_powdts
    const productArray = Array.isArray(data.kt_powdts)
        ? data.kt_powdts.map(item => ({
            ...item,
