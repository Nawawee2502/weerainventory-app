...
import { queryWh_stockcard, addWh_stockcard } from '../../../api/warehouse/wh_stockcard';
...
export default function DailyClosing() {
    ...
    // Fetch stock balance data for selected date
    ...
    const handleDone = async () => {
        try {
            ...
            for (const item of stockBalanceData) {
                ...
                await dispatch(addWh_stockcard(stockcardData)).unwrap();
            }

            Swal.fire({
                icon: 'success',
                title: 'Daily Closing Completed',
