  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div style={styles.titleText}>Receipt From Kitchen</div>
      ...
      <table style={styles.table}>
        <thead>
          <tr>
            ...
            <th style={{ ...styles.th, ...styles.leftText, width: '150px' }}>Kitchen</th>
        ...
        <tbody>
          {groupedData.map((row, index) => (
            <tr key={index}>
              ...
              <td style={{ ...styles.td, ...styles.leftText }}>{row.kitchen_code}</td>
