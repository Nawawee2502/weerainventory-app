        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Receipt From Supplier</Text>
...
export const exportToPdfWhRfs = async (data, excludePrice = false, startDate, endDate) => {
    try {
        ...
        link.href = url;
        link.download = `receipt_from_supplier_${new Date().toISOString().split('T')[0]}.pdf`;
