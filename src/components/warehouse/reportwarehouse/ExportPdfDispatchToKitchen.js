...
const DispatchToKitchenPDF = ({ data, excludePrice = false, startDate, endDate }) => {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleText}>Dispatch To Kitchen</Text>
...
export const exportToPdfWhDpk = async (data, excludePrice = false, startDate, endDate) => {
    try {
        const blob = await pdf(
            <DispatchToKitchenPDF
                data={data}
        ...
        link.href = url;
        link.download = `dispatch_to_kitchen_${new Date().toISOString().split('T')[0]}.pdf`;
