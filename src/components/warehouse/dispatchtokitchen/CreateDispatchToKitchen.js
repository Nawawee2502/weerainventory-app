...
export default function CreateDispatchToKitchen({ onBack }) {
            ...
            dispatch(searchProductName({ product_name: value }))
                ...
                .then((res) => {
                    if (res.data) {
                        ...
                        console.log("Search results:", sortedResults); // Add this debug log
    ...
    const handleDeleteWhProduct = (productCode) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const result = await dispatch(addWh_dpk(orderData)).unwrap();
    ...
    // Add useEffect to recalculate totals
    useEffect(() => {
        calculateOrderTotals();
    }, [products, quantities, units, unitPrices, deliverySurcharge]);
